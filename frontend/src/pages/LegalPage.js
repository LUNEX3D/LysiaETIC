...
const PRIVACY_POLICY = {
    ...
    sections: [
        {
            title: "1. Giri",
            content: `Pazarynetim ("Biz", "Bizim", "Platform") olarak, kullanıcılarımızın gizliliini korumayı en önemli önceliklerimizden biri olarak görüyoruz. Bu Gizlilik Politikası, kiisel verilerinizin nasıl toplandıını, kullanıldıını, saklandıını ve korunduunu açıklamaktadır.\n\nBu politika, 6698 sayılı Kiisel Verilerin Korunması Kanunu (KVKK), Avrupa Birlii Genel Veri Koruma Yönetmelii (GDPR) ve ilgili tüm veri koruma mevzuatına tam uyum salamak üzere hazırlanmıtır.`
        },
        {
            title: "2. Veri Sorumlusu",
            content: `Veri Sorumlusu: Pazarynetim\nAdres: İstanbul, Türkiye\nE-posta: info@pazaryonetim.com\nWeb: https://pazaryonetim.com`
        },
        {
            title: "3. Toplanan Kiisel Veriler",
            content: `Hesap Oluturma Sırasında: Ad ve Soyad, E-posta adresi, Şifre (ifrelenmi olarak saklanır), Telefon numarası (istee balı), Şirket bilgileri (istee balı), Vergi numarası ve vergi dairesi.\n\nKullanım Sırasında: IP adresi, Tarayıcı türü ve versiyonu, İletim sistemi, Cihaz bilgileri, Giri/çıkı zamanları, Sayfa görüntüleme istatistikleri.\n\nİlem Verileri: Pazaryeri entegrasyon bilgileri (API anahtarları ifrelenmi saklanır), rün bilgileri, Sipari verileri, Fatura bilgileri, deme ilem kayıtları (kredi kartı bilgileri saklanmaz).`
        },
        {
            title: "4. Kiisel Verilerin Kullanım Amaçları",
            content: `Hizmet Sunumu: Platform hizmetlerinin salanması, Hesap yönetimi ve kimlik dorulama, Pazaryeri entegrasyonlarının yönetimi, Sipari ve ürün yönetimi, Fatura ve ödeme ilemlerinin gerçekletirilmesi.\n\nGüvenlik: Hesap güvenliinin salanması, Dolandırıcılık tespiti ve önlenmesi, Sistem güvenlii ve istikrarının korunması, Hukuki yükümlülüklerin yerine getirilmesi.\n\nAnaliz ve İyiletirme: Hizmet kalitesinin artırılması, Kullanıcı deneyiminin iyiletirilmesi, Yeni özelliklerin gelitirilmesi, İstatistiksel analizler yapılması.`
        },
        {
        ...
        },
        {
            ...
            content: `Teknik nlemler: 256-bit SSL/TLS ifreleme, Şifrelerin bcrypt ile hash'lenmesi, API anahtarlarının ifrelenmi saklanması, İki faktörlü kimlik dorulama (2FA), Düzenli güvenlik güncellemeleri, Güvenlik duvarı koruması, DDoS saldırı koruması, Otomatik yedekleme sistemi.\n\nİdari nlemler: Eriim kontrolü ve yetkilendirme, Personel gizlilik eitimleri, Gizlilik sözlemeleri, Düzenli güvenlik denetimleri, Veri ihlali müdahale planı.\n\nVeri İhlali Bildirimi: İhlal tespit edildiinde 72 saat içinde Kiisel Verileri Koruma Kurulu'na bildirim yapılır. Etkilenen kullanıcılar derhal bilgilendirilir.`
        },
        {
            title: "7. Kullanıcı Hakları (KVKK & GDPR)",
            content: `Aaıdaki haklara sahipsiniz:\n\n Bilgi Talep Etme: Kiisel verilerinizin ilenip ilenmediini örenme\n Düzeltme Hakkı: Eksik veya yanlı verilerin düzeltilmesini talep etme\n Silme Hakkı: Kiisel verilerinizin silinmesini talep etme\n İtiraz Hakkı: Kiisel verilerinizin ilenmesine itiraz etme\n Veri Taınabilirlii: Verilerinizi yapılandırılmı formatta alma\n Şikayet Hakkı: Kiisel Verileri Koruma Kurulu'na ikayette bulunma\n\nBavurularınız 30 gün içinde ücretsiz olarak yanıtlanır.`
        },
        {
            title: "8. Saklama Süresi",
            content: ` Hesap Verileri: Hesap aktif olduu sürece + 10 yıl (vergi mevzuatı)\n İlem Kayıtları: 10 yıl (ticari kayıt zorunluluu)\n İletiim Kayıtları: 3 yıl\n Log Kayıtları: 2 yıl\n Pazarlama İzinleri: İzin geri alınana kadar`
        },
        {
...
const TERMS_OF_SERVICE = {
    ...
    sections: [
        {
            title: "1. Giri ve Kapsam",
            content: `Bu Kullanım Şartları, Pazarynetim platformu ile kullanıcılar arasındaki hukuki ilikiyi düzenler. Platformu kullanarak, bu Kullanım Şartlarını okuduunuzu, anladıınızı ve kabul ettiinizi beyan edersiniz.\n\nHizmet Salayıcı: Pazarynetim, İstanbul, Türkiye\nE-posta: info@pazaryonetim.com\nWeb: https://pazaryonetim.com`
        },
        {
            title: "2. Hesap Oluturma ve Kullanıcı Yükümlülükleri",
            content: `Kayıt Şartları: 18 yaını doldurmu olmanız, doru ve güncel bilgi salamanız, geçerli bir e-posta adresi kullanmanız gerekir.\n\nHesap Güvenlii: Hesap bilgilerinizin gizliliinden siz sorumlusunuz. Şifrenizi kimseyle paylamamalısınız. Yetkisiz eriim üphesi durumunda derhal bizi bilgilendirmelisiniz. Hesabınızda gerçekleen tüm faaliyetlerden siz sorumlusunuz.`
        },
        {
            title: "3. Yasak Faaliyetler",
            content: `Teknik Kötüye Kullanım: Platform güvenliini tehlikeye atmak, sistemlere yetkisiz eriim, zararlı yazılım yüklemek, DDoS saldırısı, API limitlerini amak, ters mühendislik.\n\nİçerik Kötüye Kullanımı: Yasa dıı içerik yüklemek, telif hakkı ihlali, yanıltıcı bilgi, spam, bakalarının verilerini izinsiz kullanmak.\n\nTicari Kötüye Kullanım: Sahte ürün satıı, fiyat manipülasyonu, stok hilesi, yasadıı ticaret.`
        },
        {
            title: "4. Hizmetler ve Paketler",
            content: `Platform aaıdaki hizmetleri sunar: oklu pazaryeri entegrasyonu, rün ve stok yönetimi, Sipari takibi, Fiyat senkronizasyonu, Kargo entegrasyonu, E-fatura, Gelimi analitik, AI destekli araçlar (LysiaBrain), Fırsat kefi (LysiaRadar PRO), Finans yönetimi.\n\nPaketler: Trial (14 gün ücretsiz), Starter, Pro, Enterprise. Detaylar fiyatlandırma sayfasında mevcuttur.`
        },
        {
            title: "5. cretler ve deme",
            content: ` Tüm fiyatlar Türk Lirası (TRY) cinsindendir, KDV dahildir\n Abonelikler otomatik olarak yenilenir\n İptal etmediiniz sürece ücretlendirme devam eder\n Kabul edilen ödeme yöntemleri: Kredi kartı, Banka kartı, Havale/EFT\n\nİptal: İstediiniz zaman iptal edebilirsiniz. Mevcut dönem sonunda geçerli olur.\n\nİade: İlk 14 gün içinde tam iade (ilk ödeme). Teknik arıza nedeniyle hizmet verilemezse orantılı iade.`
        },
        {
            title: "6. Fikri Mülkiyet Hakları",
            content: `Platform ve tüm bileenleri Pazarynetim'in münhasır mülkiyetindedir: Kaynak kodu, Tasarım ve arayüz, Logo ve ticari markalar, Algoritmalar.\n\nPlatforma yüklediiniz içerik (ürün bilgileri, görseller, müteri verileri) size aittir. Hizmet sunumu için bize sınırlı bir lisans verirsiniz.\n\nYAPAMAZSINIZ: Platformu kopyalamak, kaynak kodunu çıkarmak, yeniden satmak, rakip ürün gelitirmek için kullanmak.`
        },
        {
        ...
        },
        {
            ...
            content: `Bu sözleme Türkiye Cumhuriyeti kanunlarına tabidir. Uyumazlıklarda İstanbul Mahkemeleri ve İcra Daireleri yetkilidir.\n\nDava açmadan önce: Müteri hizmetleri ile iletiime geçin, Arabuluculuk sürecini deneyin, Tüketici Hakem Heyeti'ne bavurabilirsiniz.\n\nDelil Sözlemesi: Elektronik kayıtlar, e-posta ve platform bildirimleri delil olarak kabul edilir.`
        },
        {
            title: "9. Mesafeli Satı ve Tüketici Hakları",
            content: `6502 sayılı Tüketicinin Korunması Hakkında Kanun uyarınca: 14 gün cayma hakkı vardır (ilk satın alma). Cayma hakkı kullanıldıında tam iade yapılır.\n\n6563 sayılı Kanun uyarınca: Pazarlama e-postaları için onay gereklidir. İstediiniz zaman abonelikten çıkabilirsiniz.`
        },
        {
            title: "10. Genel Hükümler",
            content: `Sözleme Deiiklikleri: nemli deiiklikler 30 gün önceden duyurulur. Devam eden kullanım, deiikliklerin kabulü anlamına gelir.\n\nMücbir Sebepler: Doal afetler, sava, hükümet kararları, internet kesintileri, siber saldırılar, salgın hastalıklar mücbir sebep sayılır.\n\nİletiim: info@pazaryonetim.com | legal@pazaryonetim.com`
        }
    ]
};
...
const COOKIE_POLICY = {
    ...
    sections: [
        {
            title: "1. Giri",
            content: `Pazarynetim olarak, web sitemizde ve uygulamamızda çerezler ve benzeri teknolojiler kullanıyoruz. Bu erez Politikası, hangi çerezleri kullandıımızı, neden kullandıımızı ve çerezleri nasıl kontrol edebileceinizi açıklar.\n\nBu politika, KVKK, GDPR ve ilgili elektronik iletiim mevzuatına uygun olarak hazırlanmıtır.`
        },
        {
            title: "2. erez Nedir?",
            content: `erezler, web sitelerini ziyaret ettiinizde cihazınıza kaydedilen küçük metin dosyalarıdır. Web sitesinin düzgün çalımasını salar, kullanıcı deneyimini iyiletirir ve analitik bilgi salar.\n\nOturum erezleri: Tarayıcıyı kapattıınızda silinir.\nKalıcı erezler: Belirli bir süre cihazınızda kalır.\nBirinci Taraf: Dorudan bizim tarafımızdan yerletirilir.\nçüncü Taraf: Ortaklarımız tarafından yerletirilir.`
        },
        {
    ...
    sections: [
        {
            ...
            content: `Ticari Unvan: Pazarynetim\nAdres: İstanbul, Türkiye\nTelefon: Platformda belirtilen iletiim numarası\nE-posta: info@pazaryonetim.com\nWeb Sitesi: https://pazaryonetim.com`
        },
        {
