...
/** PazarYonet — merkezi marka sabitleri (UI) */
export const BRAND_NAME = "PazarYonet";
export { APP_DOMAIN, APP_SITE_URL };
export const BRAND_NAME_UPPER = "PAZARYONET";
export const BRAND_TAGLINE = "Pazaryeri yönetim platformu";
export const BRAND_PANEL_SUB = "Yönetim Paneli";
export const BRAND_ADMIN_TAG = "SaaS Yönetim Konsolu";
export const BRAND_AI = "PazarYonet AI";
