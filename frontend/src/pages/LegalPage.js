...
const PRIVACY_POLICY = {
    ...
    sections: [
        {
            title: "1. Giri",
            content: `Dashtock ("Biz", "Bizim", "Platform") olarak, kullanıcılarımızın gizliliçini korumayı en önemli önceliklerimizden biri olarak görüyoruz. Bu Gizlilik Politikası, kiisel verilerİşinizin nasıl toplandıını, kullanıldıını, saklandıını ve korunduunu açıklamaktadır.\n\nBu politika, 6698 sayılı Kiisel Verilerin Korunması Kanunu (KVKK), Avrupa Birlii Genel Veri Koruma Yönetmelii (GDPR) ve ilgili tüm veri koruma mevzuatına tam uyum salamak üzere hazırlanmıtır.`
        },
        {
            title: "2. Veri Sorumlusu",
            content: `Veri Sorumlusu: Dashtock\nAdres: İstanbul, Türkiye\nE-posta: info@dashtock.com\nWeb: https://dashtock.com`
        },
        {
    ...
    sections: [
        {
            ...
            content: `Bu Kullanım Şartları, Dashtock platformu ile kullanıcılar arasındaki hukuki ilikiyi düzenler. Platformu kullanarak, bu Kullanım Şartlarını okuduunuzu, anladıınızı ve kabul ettiİşinizi beyan edersiniz.\n\nHizmet Salayıcı: Dashtock, İstanbul, Türkiye\nE-posta: info@dashtock.com\nWeb: https://dashtock.com`
        },
        {
        ...
        },
        {
            ...
            content: `Platform aaıdaki hizmetleri sunar: oklu pazaryeri entegrasyonu, rün ve stok yönetimi, Sipariş takibi, Fiyat senkâronizasyonu, Kargo entegrasyonu, E-fatura, Gelişmiş analitik, AI destekli araçlar (Dashtock AI), Fırsat keşfi (Dashtock Radar), Finans yönetimi.\n\nPaketler: Trial (14 gün ücretsiz), Starter, Pro, Enterprise. Detaylar fiyatlandırma sayfasında mevcuttur.`
        },
        {
...
const COOKIE_POLICY = {
    ...
    sections: [
        {
            title: "1. Giri",
            content: `Dashtock olarak, web sitemizde ve uygulamamızda çerezler ve benzeri teknolojiler kullanıyoruz. Bu erez Politikası, hangi çerezleri kullandıımızı, neden kullandıımızı ve çerezleri nasıl kontrol edebileceİşinizi açıklar.\n\nBu politika, KVKK, GDPR ve ilgili elektronik iİletişim mevzuatına uygun olarak hazırlanmıtır.`
        },
        {
            title: "2. erez Nedir?",
    ...
    sections: [
        {
            ...
            content: `Ticari Unvan: Dashtock\nAdres: İstanbul, Türkiye\nTelefon: Platformda belirtilen iİletişim numarası\nE-posta: info@dashtock.com\nWeb Sitesi: https://dashtock.com`
        },
        {
            ...
            <div className="legal-content">
                ...
                <div className="legal-main">
                    ...
                    <div className="legal-doc-footer">
                        <p>Bu belge yasal olarak balayıcıdır. Sorularınız için <strong>info@dashtock.com</strong> adresine bavurabilirsiniz.</p>
                        <p>© {new Date().getFullYear()} Dashtock. Tüm hakları saklıdır.</p>
                    </div>
                </div>
            </div>
        </div>
