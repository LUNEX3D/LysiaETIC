...
import { exportStoreBrands } from "../../../services/storeApi";
...
const BrandExportModal = ({ open, onClose }) => {
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const { blob, filename } = await exportStoreBrands();
